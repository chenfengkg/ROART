...
int main(int argc, char **argv) {
    ...
    system("rm -rf /data/pmem0/roart/matianmao/acmma.data");
    system("rm -rf /data/pmem0/roart/matianmao/part.data");

    const char *pool_name = "/data/pmem0/roart/matianmao/acmma.data";
